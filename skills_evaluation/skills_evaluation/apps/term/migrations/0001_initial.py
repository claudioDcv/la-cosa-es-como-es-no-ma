    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='eval_student', to=settings.AUTH_USER_MODEL)),
                ('teacher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='eval_teacher', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_ts', models.DateTimeField(auto_now=True)),
                ('value', models.FloatField()),
                ('final_note_evaluation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='term.FinalNoteEvaluation')),
            ],
            options={
                'abstract': False,
            },
